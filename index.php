...
<body>
    ...
    <!-- service_area  -->
    <div data-scroll-index="0" class="service_area" id="service" style="background-color: ghostwhite;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >Services</h3>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    ...
                    <div class="single_service text-center wow fadeInLeft" data-wow-duration="1.2s" data-wow-delay=".4s" style="border: 1px solid purple;">
                        ...
                        <h3>IT support</h3>
                        <div class="justify-content-left fadeInLeft">
                        <ul style="text-align:left">
                          <li><i class="ri-check-double-line"></i> Help desk, File servers</li>
                          <li><i class="ri-check-double-line"></i> Email, Computer repair </li>
                          <li><i class="ri-check-double-line"></i> Cloud services, Virtual desktops</li>
                          <li><i class="ri-check-double-line"></i> Data security, Data backups</li>
              ...
              <li><i class="ri-check-double-line"></i> Web hosting (Space, email, Domain registration) </li>
              ...
              <li><i class="ri-check-double-line"></i> Marketing videos </li>
              <br/>
              <br/>
              <br/>
              <br/>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center ">
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >About Us</h3>
...
<hr class="mb-2 mt-2" style="width: 90%;">  
    ...
    <!-- team_member_start -->
    <div class="team_area" id="team" style="background-color: ghostwhite;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-90">
                        <h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Our Creative Team</h3>
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">Meet Our Amazing Team.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="team_thumb">
                            <img src="img/team/benie%20mooya.jpg" alt="" style="border-radius: 30px;">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        <div class="team_thumb">
                            <img src="img/team/Banura%20Evelyne.jpg" alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        <div class="team_thumb">
                            <img src="img/team/Tallen.Tech.jpg" alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">
                        <div class="team_thumb">
                            <img src="img/team/Gerald%20Tumwine.jpg " alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="team_thumb">
                            <img src="img/team/aturinda%20ignatius.jpg"  alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        <div class="team_thumb">
                            <img src="img/team/Mwesigwa%20Steven.jpg" alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        <div class="team_thumb">
                            <img src=" img/team/Mundruku%20ivan.jpg " alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single_team wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">
                        <div class="team_thumb">
                            <img src="img/team/k.jpg" alt="" style="border-radius: 30px;">
                            <div class="team_hover">
                                <div class="hover_inner text-center">
                                    <ul>
                                        <li><a href="#"> <i class="fa fa-facebook"></i> </a></li>
    ...
    <div data-scroll-index="0" class="get_in_tauch_area" id="contact" style="background-color: ghostwhite;">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="touch_form">
                        <form action="contact_process.php" method="post" novalidate="novalidate">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="single_input wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                                       <textarea class="form-control" name="message" id="message" cols="30" rows="10" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder = 'Enter Message'></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
            ...
            <div class="media-body">
                <h3>Nansana, Bujuukko. </h3>
                <p>Wakiso District.<br> P.O.Box 72122 Kampala, Uganda</p>
            </div>
          </div>
                   <div class="media contact-info">
